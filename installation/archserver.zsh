...
log_warning "You will be dropped into partition tool to perform custom partitioning. Minimum 2 partitions need to be created root and efi"
...
arch-chroot /mnt /usr/bin/zsh /root/dotfiles/installation/archserver_root.zsh
